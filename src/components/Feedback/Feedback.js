...
class Feedback extends Component {
    ...
    showBanner() {
        ...
        switch (this.props.messageStatus) {
            case 'success': errMessage = "Thank you for your feedback";
                break;
            case 'error': errMessage = "Sorry Couldn't send your message. Please try again later.";
                break;
            case 'neutral': errMessage = "Submitting your feedback...";
                break;
            default: errMessage = '';
                break;
        }
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        updateBannerStatus: (value) => dispatch({ type: 'UPDATE_BANNER', data: value })
    }
}
