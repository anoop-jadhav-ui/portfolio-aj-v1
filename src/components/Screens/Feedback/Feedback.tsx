...
const Feedback = () => {
    ...
    return (
        <>
            ...
            <form id="contact-form" className="subsection" onSubmit={event => sendEmail(event)} method="POST">
                <div className="subsection-data">
                    <label htmlFor="feedback-box" className="subsection-title body-text letterspacing-1">
                        {T.FEEDBACK_MESSAGE}
                    </label>
