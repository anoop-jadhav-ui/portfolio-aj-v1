            ...
            <div className="subsection">
                ...
                <div className="subsection-data">
                    {development.map((skill, key) => {
                        return (
                            <div key={key} className="skill-bar-wrapper row no-gutters align-items-center">
                                <div className="skill-label grey-1 body-text bold col-md-3">{skill.skillName}</div>
                                <BarGraph className="col-md-9" value={skill.skillValue} animate={true} />
                            </div>
                        );
                    })}
                </div>
