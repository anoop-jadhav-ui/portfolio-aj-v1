  ...
  render() {
    return (
      ...
      >
        ...
        <img src={myImage} className={`mainlogo ${this.state.imageStatus}`} alt="mi Baburao" loading="eager" onLoad={this.handleImageLoaded.bind(this)} onError={this.handleImageErrored.bind(this)} />
