...
export const sectionDetails = {
    ...
    recentArticles: {
        ...
        label: 'sectionName.recentArticles',
        id: 'recentArticles',
        headerPos: 0,
        icon: <Newspaper />,
    },
    projects: {
        ...
        label: 'sectionName.funLearningProjects',
        id: 'projects',
        headerPos: 0,
        icon: <Lightbulb />,
    },
    experience: {
        ...
        label: 'sectionName.workExperience',
        id: 'experience',
        headerPos: 0,
    ...
    certifications: {
        ...
        label: 'sectionName.certifications',
        id: 'certifications',
        headerPos: 0,
        icon: <Award />,
    },
    hobbies: {
        ...
        label: 'sectionName.hobbiesAndInterests',
        id: 'hobbies',
        headerPos: 0,
        icon: <Gamepad2 />,
    },
    getInTouch: {
        ...
        label: 'sectionName.messageFormTitle',
        id: 'getInTouch',
        headerPos: 0,
    ...
    contactDetails: {
        ...
        label: 'sectionName.contactDetails',
        id: 'contactDetails',
        headerPos: 0,
        icon: <Contact />,
    },
