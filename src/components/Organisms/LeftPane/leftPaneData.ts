...
export default function getFilteredLeftPaneData(featureToggles: FeatureToggles) {
    return leftPaneDataObj.filter(item => !!featureToggles[item.id as keyof FeatureToggles]);
}
